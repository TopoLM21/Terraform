...
constexpr double kMinimumTemperatureKelvin = 3.0;
}
...
SurfaceTemperatureState::SurfaceTemperatureState(double initialTemperatureKelvin,
    ...
    : temperatureKelvin_(qMax(kMinimumTemperatureKelvin, initialTemperatureKelvin)),
...
void SurfaceTemperatureState::setTemperatureKelvin(double temperatureKelvin) {
    temperatureKelvin_ = qMax(kMinimumTemperatureKelvin, temperatureKelvin);
}
...
void SurfaceTemperatureState::updateTemperature(double solarIrradiance, double dtSeconds) {
    ...
    temperatureKelvin_ = qMax(kMinimumTemperatureKelvin, temperatureKelvin_ + dT);
}
