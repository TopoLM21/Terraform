...
double OrbitAnimationModel::declinationDegrees() const {
    const double solarLongitude = orbitalPhaseRadians();
...
double OrbitAnimationModel::orbitalPhaseRadians() const {
    ...
    return segment.trueAnomalyRadians + perihelionArgumentRadians;
}
